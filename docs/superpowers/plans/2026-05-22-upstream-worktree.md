...
**Goal:** Add a CodexForge enhancement that creates new Git worktrees from a fresh remote tracking ref such as `upstream/main` instead of stale local `HEAD`.
...
### Task 4: Add CodexForge menu workflow
...
Then launch CodexForge from the built app or development launcher, open the CodexForge menu, create:
