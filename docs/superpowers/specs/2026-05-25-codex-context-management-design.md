...
Add Codex-only management for MCP servers, skills, and plugins, using the same switching concept as CCSwitch while staying inside CodexForge's current settings and relay profile model.
