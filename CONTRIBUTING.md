# Contributing to CodexForge

Thank you for your interest in contributing to CodexForge!

## Development Setup

1. **Clone the repository**
   ```bash
   git clone https://github.com/CloudRelay-Code/CodexForge.git
   cd CodexForge
   ```
...
│   └── codex-plus-core/    # Core CodexForge logic
