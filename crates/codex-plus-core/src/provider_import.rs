...
fn build_config_toml(base_url: &str, api_key: &str, protocol: RelayProtocol) -> String {
    ...
    [
        "model_provider = \"CodexForge\"".to_string(),
        String::new(),
        "[model_providers.CodexForge]".to_string(),
        "name = \"CodexForge\"".to_string(),
...
mod tests {
    ...
    #[test]
    fn parses_codexforge_provider_url() {
        let url = "codexforge://v1/import/provider?resource=provider&name=JOJO%20Code&baseUrl=https%3A%2F%2Fjojocode.com%2Fv1&apiKey=sk-test&wireApi=responses&relayMode=pureApi&configContents=bW9kZWxfcHJvdmlkZXIgPSAiQ29kZXhQbHVzUGx1cyIK&authContents=eyJPUEVOQUlfQVBJX0tFWSI6InNrLXRlc3QifQo%3D";
