...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read CodexForge Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse CodexForge Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write CodexForge Zed remote project registry")]
