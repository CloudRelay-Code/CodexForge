...
const APP_STATE_DIR: &str = ".codexforge";
...
mod tests {
    ...
    fn default_settings_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".codexforge/settings.json"));
    }
    ...
    fn default_latest_status_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".codexforge/latest-status.json"));
    }
    ...
    fn default_diagnostic_log_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".codexforge/codex-plus.log"));
    }
    ...
    fn default_pending_provider_import_path_uses_app_state_directory() {
        ...
        assert!(path.ends_with(".codexforge/pending-provider-import.json"));
    }
}
