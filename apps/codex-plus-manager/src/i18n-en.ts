// English translations for the CodexForge manager UI, keyed by the original
...
export const EN_PLAIN: Record<string, string> = {
  ...
  "CodexForge 导入": "CodexForge import",
  "CodexForge 版本": "CodexForge version",
  ...
  "Watcher 用于保持 CodexForge 接管状态": "The watcher keeps CodexForge in control",
  ...
  "保存到 CodexForge state，不改写 Zed settings。": "Saved to CodexForge state, does not modify Zed settings.",
  ...
  "关于": "About",
  "关于 CodexForge": "About CodexForge",
  "关闭": "Off",
  ...
  "卸载时移除 CodexForge 托管数据": "Remove CodexForge managed data on uninstall",
  ...
  "启动 CodexForge": "Launch CodexForge",
  "启动任务": "Launch task",
  ...
  "导入 CodexForge 供应商": "Import CodexForge provider",
  ...
  "开启": "On",
  "开启后，通过 CodexForge 启动 Codex 前自动整理一次旧对话的归属标记。":
    "When on, tidies up ownership tags of old conversations once before launching Codex through CodexForge.",
  ...
  "把 CodexForge 菜单插入 Codex 顶部原生菜单栏。": "Insert the CodexForge menu into Codex's top native menu bar.",
  ...
  "使用 CodexForge 内置快照补齐远端插件，API 模式也可显示和安装 Product Design 插件。":
    "Use the embedded CodexForge snapshot to add remote plugins, so API mode can also show and install the Product Design plugin.",
  ...
  "未发现本地缓存；点击按钮会从 CodexForge 内置快照释放并注册，无需官方账号预缓存。":
    "Local cache not found. Click the button to extract and register the embedded CodexForge snapshot; no official-account pre-cache is required.",
  "未知": "Unknown",
  "未知作者": "Unknown author",
  "未知来源": "Unknown source",
  ...
  "检测到来自网页的供应商配置导入请求，确认后会写入本机 CodexForge 管理工具。":
    "A provider config import request from the web was detected; confirming writes it to this machine's CodexForge manager.",
  "概览": "Overview",
  ...
  "正常": "OK",
  "此上游会通过本地 127.0.0.1:57321 转成 Responses API，需要从 CodexForge 启动 Codex。":
    "This upstream is converted to the Responses API via local 127.0.0.1:57321, which requires launching Codex from CodexForge.",
  ...
  "维护 CodexForge 自己的远程项目最近列表。": "Maintain CodexForge's own recent list of remote projects.",
  "编辑": "Edit",
  "编辑后保存列表，再切换模式时会使用新配置": "After editing, save the list; the new config is used the next time you switch modes",
  "编辑扩展项": "Edit entry",
  "缺失": "Missing",
  "缺少 CodexForge 静默启动快捷方式时可在安装维护页修复。": "When the CodexForge silent launch shortcut is missing, repair it on the Install & Maintenance page.",
  ...
  "配置文件": "Config file",
  "配置模型": "Config model",
  "重启 CodexForge": "Restart CodexForge",
  "重新安装": "Reinstall",
  "重新生成": "Regenerate",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "{0} 个": "{0}",
  "{0} 个 CodexForge 可识别项目，默认策略：{1}": "{0} project(s) recognized by CodexForge, default strategy: {1}",
  "{0} 个供应商": "{0} provider(s)",
  ...
  "检测到代理环境变量：{0}。请清理后重新启动 CodexForge。":
    "Proxy environment variables detected: {0}. Remove them and restart CodexForge.",
